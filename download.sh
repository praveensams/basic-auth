...
for app in prod-communication-sms-v1  prod-home-delivery-process-v1  prod-online-order-processing-v1  prod-payment-processing-v1  prod-order-tracking-process-v1
do
